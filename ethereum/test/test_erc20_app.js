...
contract('ERC20App', function (accounts) {
  ...
  describe('deposits', function () {
    ...
    it('should support ERC20 deposits', async function () {
      ...
      const { logs } = await this.erc20App.sendERC20(recipient, this.token.address, amount, {
        from: userOne,
        value: 0,
      }).should.be.fulfilled
  ...
  describe('handle received messages', function () {
    before(async function () {
      ...
      await this.erc20App.sendERC20(recipient, this.token.address, lockAmount, {
        from: userOne,
        value: 0,
      }).should.be.fulfilled
    })
    ...
    it('should support ERC20 unlocks', async function () {
      ...
      const encodedData =
        '0xd43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27dcffeaaf7681c89285d65cfbe808b80e502696573' +
        encodedTokenAddress +
